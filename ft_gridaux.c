...
/*   Updated: 2016/03/02 18:03:58 by pbie             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	mlx->y2 = mlx->nb[i][j - 1] != 0 ? mlx->y2 - (mlx->nb[i][j - 1] * mlx->z) : mlx->y2;
	mlx->y1y = mlx->nb[i][j] != 0 ? mlx->y1y - (mlx->nb[i][j] * mlx->z) : mlx->y1y;
...
{
	mlx->y2 = mlx->nb[i + 1][j] != 0 ? mlx->y2 - (mlx->nb[i + 1][j] * mlx->z) : mlx->y2;
	mlx->y1y = mlx->nb[i][j] != 0 ? mlx->y1y - (mlx->nb[i][j] * mlx->z) : mlx->y1y;
