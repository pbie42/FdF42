...
/*   Updated: 2016/02/26 17:22:08 by pbie             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	mlx->y2 = nb[i][j - 1] != 0 ? mlx->y2 - (nb[i][j - 1] * 3) : mlx->y2;
	mlx->y1y = nb[i][j] != 0 ? mlx->y1y - (nb[i][j] * 3) : mlx->y1y;
...
{
	mlx->y2 = nb[i + 1][j] != 0 ? mlx->y2 - (nb[i + 1][j] * 3) : mlx->y2;
	mlx->y1y = nb[i][j] != 0 ? mlx->y1y - (nb[i][j] * 3) : mlx->y1y;
